...
# Connect button
connect_button = Button(connection_frame, text="Connect", command=connect_to_server, bg="#77b300", fg="white", width=15, height=1, font=("Arial", 25) )  # 設置寬度和高度
connect_button.grid(row=2, column=1, columnspan=1, pady=4) 

# Disconnect button
disconnect_button = Button(connection_frame, text="Disconnect", command=disconnect_from_server, bg="#c00", fg="white", width=15, height=1, font=("Arial", 25) ) # 設置寬度和高度
...
# Send button
send_button = Button(command_frame, text="send", command=send_command, bg="#2196F3", fg="white", width=15, height=1, font=("Arial", 25) ) # 設置字體大小  # 設置寬度和高度
...
# 日誌顯示區域
log_text = Text(log_frame, state='disabled', width=50, height=50,fg="#f0f0f0", bg="#222",font=("Arial", 20))
